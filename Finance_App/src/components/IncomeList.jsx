...
<div className="w-full p-2 md:p-4">
       ...
       <h2 className="text-xl font-semibold text-white p-4 text-center">Income</h2>
        ...
        <tr key={index} className="hover:bg-gray-700 transition-colors duration-150">
          ...
          <td className="px-3 py-4 sm:px-4 whitespace-nowrap text-sm text-gray-100">
            ...
            {transaction.name}
                ...
                <td className="px-3 py-4 sm:px-4 whitespace-nowrap text-sm text-green-500 font-medium">
